...
class AssessmentDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Fetch the current user's information from Firebase Authentication
    final User? user = FirebaseAuth.instance.currentUser;
    final String studentId = user?.uid ?? '';
    final bool isAdmin = user?.email == 'admin@gmail.com'; // Define admin user
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          // Check if the user is a student and fetch their submission status
          return FutureBuilder<DocumentSnapshot>(
            future: isAdmin
                ? null // No need to fetch submission status for admin
            ...
            builder: (context, submissionSnapshot) {
              ...
              if (!isAdmin &&
                  submissionSnapshot.connectionState == ConnectionState.done &&
                  submissionSnapshot.hasData &&
                  submissionSnapshot.data?.data() != null) {
                final submissionData =
                    submissionSnapshot.data!.data() as Map<String, dynamic>;
                hasSubmitted = submissionData['status'] == 'submitted';
              }
